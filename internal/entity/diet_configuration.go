...
func DefaultDietConfiguration() *DietConfiguration {
	return &DietConfiguration{
		LifestyleAndWorkouts: `Работаю в офисе, сижу за компьютером. В день прохожу примерно 3 км. 
Занимаюсь кроссфитом 4 раза в неделю, по 2-3 часа каждая тренировка.`,
		TimeRestrictions: "Тренировка с 18:00 до 21:00, по-этому нет возможности есть в это время.",
		PFC: PFC{
			Proteins: 20,
			Fats:     30,
			Carbs:    40,
...
5. Завтрак - самый главный прием пищи.`,
		IndividualRestrictions: `1. Не есть после 18:00.
2. Не есть сладкое.
...
8. Два вида тушеных овощей вместо множества отдельных блюд. Чтобы не готовить слишком много.`,
		FoodConfiguration: FoodConfiguration{
			BreakfastCereals: "овсянка,кукурузная каша",
			SideDishCereals:  "рис,гречка,булгур",
			Vegetables:       "капуста,брокколи,кабачки,морковь,свекла,лук,перец,баклажаны,томаты,огурцы,свекла,морковь,лук,перец,баклажаны,томаты,огурцы",
			Fruits:           "яблоко,груша,апельсин",
			NutsAndSeeds:     "миндаль,кешью,арахис",
			DairyProducts:    "молоко,кефир,сыр",
			Fish:             "рыба",
			Bread:            "белый,черный,пшеничный",
			Eggs:             true,
		},
	}
}
